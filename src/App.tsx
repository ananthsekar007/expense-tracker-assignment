        ...
        <div className="flex flex-col w-full gap-4 p-5">
          ...
          <div className="flex flex-col w-full gap-1">
            ...
            <label className="input bg-[#374151] border-[#374151] w-full">
              ...
              <input type="date" className="grow bg-[#374151] text-gray-300" />
            </label>
          </div>
          ...
          <div className="flex justify-between w-full mt-2">
            <button className="btn btn-primary flex-1 mr-2">
              Add Transaction
            </button>
            <button className="btn btn-secondary flex-1 ml-2">Clear</button>
          </div>
        </div>
      </div>
    </div>
